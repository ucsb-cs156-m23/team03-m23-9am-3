...
describe("UCSBOrganizationsIndexPage tests", () => {
    ...
    test("Renders with Create Button for admin user", async () => {
        ...
        const button = screen.getByText(/Create New Organization/);
    ...
    test("renders three UCSBOrganization correctly for regular user", async () => {
        ...
        const createButton = screen.queryByText(/Create New Organization/);
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        axiosMock.onGet("/api/ucsborganizations/all").reply(200, ucsbOrganizationsFixtures.threeOrganizations);
        axiosMock.onDelete("/api/ucsborganizations").reply(200, "UCSB Organization with orgCode ZPR was deleted");
