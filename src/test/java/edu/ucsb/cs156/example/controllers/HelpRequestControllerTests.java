...
public class HelpRequestControllerTests extends ControllerTestCase {
        ...
        public void logged_out_users_cannot_get_all() throws Exception {
                mockMvc.perform(get("/api/helprequest/all")) .andExpect(status().is(403)); // logged out users can't get all
        }
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                HelpRequest helpRequest = HelpRequest.builder()
                                .requesterEmail("hello@gmail.com")
                                .teamId("2")
        ...
        public void logged_in_user_can_get_all_helprequests() throws Exception {
                ...
                HelpRequest helpRequest2 = HelpRequest.builder()
                                .requesterEmail("zxcvbnm@gmail.com")
                                .teamId("5")
        ...
        public void an_admin_user_can_post_a_new_helprequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/helprequest/post?requesterEmail=hello@gmail.com&teamId=2&tableOrBreakoutRoom=table&requestTime=2022-01-03T00:00:00&explanation=yes?&solved=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
