...
public class ArticlesController extends ApiController {
    ...
    public Articles postArticles(
            ...
            @Parameter(name="dateAdded", description = "date (in iso format, e.g. YYYY-mm-ddTHH:MM:SS; see https://en.wikipedia.org/wiki/ISO_8601)\", example=\"2023-12-01T13:15\"") @RequestParam LocalDateTime dateAdded)
